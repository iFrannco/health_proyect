...
$routes->group('paciente', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('documentacion', 'Paciente\Documentacion::index', ['as' => 'paciente_documentacion_index']);
    $routes->post('documentacion', 'Paciente\Documentacion::store', ['as' => 'paciente_documentacion_store']);
    $routes->post('documentacion/(:num)', 'Paciente\Documentacion::update/$1', ['as' => 'paciente_documentacion_update']);
    $routes->delete('documentacion/(:num)', 'Paciente\Documentacion::delete/$1', ['as' => 'paciente_documentacion_delete']);
    $routes->get('documentacion/(:num)/descargar', 'Paciente\Documentacion::descargar/$1', ['as' => 'paciente_documentacion_descargar']);
...
$routes->group('medico', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('planes/diagnosticos/plantillas', 'Medico\Planes::planesEstandarPorDiagnostico', ['as' => 'medico_planes_plantillas_diagnostico']);
    $routes->post('planes/plantillas/previsualizar', 'Medico\Planes::previsualizarPlanEstandar', ['as' => 'medico_planes_previsualizar']);
    ...
    $routes->post('planes/(:num)/finalizar', 'Medico\Planes::finalizar/$1', ['as' => 'medico_planes_finalizar']);
